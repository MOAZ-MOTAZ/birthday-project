...
// ── Loader ──
// PERF: use visibilitychange + setTimeout so the timer doesn't
// count down while the tab is in the background.
...
function goToLetter() {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => letterSection.classList.add("active"), 200);
  }, 900);
}
...
startBtn.addEventListener("click", () => {
  ...
  setTimeout(() => cakeSection.classList.add("active"), 200);
});
